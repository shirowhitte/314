  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="searchUserProfile.php" class="active">
            <i class='bx bx-street-view'></i>
        ...
        <div class="recent-sales box" style="height: 100%;width:100%">
          <div class="title" >
            ...
            if (isset($_POST['searchUser'])) 
            {
              ...
              if($searchUser->onSubmit($role, $att, $search))
              {
                $searchUser->validateFields($search);
              }

              if($searchUser->getUserInfo($search))
              {
                  $searchUser->displayUsersInfoPage();
              }
              else
              {
                 $searchUser->displayErrMsg();
              }
