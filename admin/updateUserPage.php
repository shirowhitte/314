...
include_once 'updateUserCTRL.php';
include_once '../assets/conn/dbconnect.php';//connectio

session_start();

$viewUsers = new viewUsersControl();
...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="viewUsersPage.php" class="active">
  ...
  <section class="home-section">
    ...
    <div class="home-content">
        ...
        <div class="recent-sales box" style="height: 100%;width:100%">
          <div class="title" >
            <form method="post" action="viewUsersPage.php" style="text-align: center;">
                   <h3>View User</h3><br>
                    <select style="width: 30%;" name="role" id="role">
                    ...
                    <input style="background-color: #59788e;font-size: 10px;width:30%"type="submit" name="selectRole" value="Select Role">
            ...
            if (isset($_POST['selectRole'])) 
            {
              $role = $_REQUEST['role'];
              {
                $viewUsers->getUserListing();
              }
            }

            $update->displayUpdateUserPage();

            if (isset($_POST['update'])) 
            {  

                $submit = $update->onSubmit($_REQUEST['id'],$_REQUEST['name'],$_REQUEST['email'],$_REQUEST['mobile'],$_REQUEST['gender']);  
                if($submit)
                { 
                    $update->validateFields($_REQUEST['id'],$_REQUEST['name'],$_REQUEST['email'],$_REQUEST['mobile'],$_REQUEST['gender']);  
                    $update->updateUserAcc($_REQUEST['id'],$_REQUEST['name'],$_REQUEST['email'],$_REQUEST['mobile'],$_REQUEST['gender']);  
                     echo "<br><p style='color:black;text-align:center;'>Updated Successfully.</p>";  
                }
                else
                {  
          ...
          <a href="viewUsersPage.php">Previous Page</a>
