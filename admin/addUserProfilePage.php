...
include_once 'addUserProfilePageCTRL.php';//connection
include_once '../assets/conn/dbconnect.php';//connectio

session_start();

$addUserPC = NEW addUserProfileCTRL();
...
<div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="addUserProfilePage.php" class="active" >
            <i class='bx bx-user-plus' ></i>
    ...
    <div class="home-content">
        ...
        <div class="recent-sales box" style="height: 100%;width:100%">
          <div class="title" style="text-align: center;" >
            ...
            $addUserPC->displayAddUserProfilePage();

            if ($_SERVER["REQUEST_METHOD"] == "POST") 
            {
              $role = $_REQUEST['role'];
              
              $submit = $addUserPC->onSubmit($role);
              if($submit)
              {
                $addUserPC->validateFields($role);
                $addUserPC->addUserProfile($role);
