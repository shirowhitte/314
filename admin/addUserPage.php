...
include_once 'addUserPageCTRL.php';//connection
include_once '../assets/conn/dbconnect.php';//connectio

session_start();

$addUser = new addUserPageCTRL();
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="addUserPage.php" class="active" >
    ...
    <div class="home-content">
        ...
        <div class="recent-sales box"style="height: 100%;width:100%">
          <div class="title" >
           ...
           <?php echo $addUser->displayAddUserPage();

            if ($_SERVER["REQUEST_METHOD"] == "POST")
            {  
                $submit = $addUser->onSubmit($_REQUEST['id'],$_REQUEST['name'],$_REQUEST['email'],$_REQUEST['mobile'],$_REQUEST['password'],$_REQUEST['gender'],$_REQUEST['role']);  
                if($submit)
                { 
                    $addUser->validateFields($_REQUEST['id'],$_REQUEST['name'],$_REQUEST['email'],$_REQUEST['mobile'],$_REQUEST['password'],$_REQUEST['gender'],$_REQUEST['role']);  
                    $addUser->createUserAcc($_REQUEST['id'],$_REQUEST['name'],$_REQUEST['email'],$_REQUEST['mobile'],$_REQUEST['password'],$_REQUEST['gender'],$_REQUEST['role']);  
                    echo "Added successfully.";
                }
                else
                {  
                    $addUser->displayErrMsg();
                }  
            }   
            ?>
        </div>
