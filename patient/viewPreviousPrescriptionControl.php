...
class viewPreviousPrescriptionControl
{
    ...
    {  
        ...
        $query = "select * from prescription where status='Collected' and patientid='$patientId'";
        $res = mysqli_query($conn, $query);
                    ...
                    if(mysqli_num_rows($res)>0)
                    {
                        ...
                        while($Row = $res->fetch_array())
                        {
                            ...
                            ?>
                            <td><form method="post" action="viewPreviousPrescriptionPage.php">
        ...
        public function displayViewPrescriptionDetailPage()
        {
            ...
            <tr>       
                ...
                <tr>
                    <td colspan="2"><br><a href="viewPreviousPrescriptionPage.php" style="background-color: #016064;font-size: 20px;width:500px;">BACK</a></td>
                </tr>                                   
            </tbody>
        </table>
        </form>
